...
## Current status (as of 2026-09-04 — check `PHASE_LOG.md` for anything more recent)

**Real:** React/TypeScript frontend, Express dev server, API shell (`/api/health`, `/api/generate-brief`, `/api/mempool/address/:addr`), LLM report generation, complaint-intake UI, report/graph visualization UI, bulk-convergence UI.
