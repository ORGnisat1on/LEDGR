...
- **➡ Separate line item: honesty-layer UI implementation — ✅ DONE (2026-09-06, Phase R8).** Implemented in `MethodologyModal.tsx` + App footer banner; verified via `tsc --noEmit` and the R8 hardening pass.
